...
/*
Поиск элемента document и всех его подэлементов во всех файлах xml,
которые лежат в текущей директории, для каждого файла xml создает папку
с названием аттрибута unid поля noteinfo и в этой папке xml файлы содержащие результаты поиска
 */
